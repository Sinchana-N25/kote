...
const PurohitView = () => {
  ...
  const kn_whatsapp_template = (namesList, date, photoUrl) => {
    return (
      `🙏 *ಶ್ರೀ ಸತ್ಯಗಣಪತಿ ದೇವಸ್ಥಾನ, ಎಂ.ಎನ್.ಕೋಟೆ* 🙏\n\n` +
      `🕉 ದಿನಾಂಕ *${date}* ರಂದು *${namesList}* ಹೆಸರಿನಲ್ಲಿ ವಿಶೇಷ ಪೂಜೆ ನೆರವೇರಿದೆ.\n\n` +
      `🌟 ಶ್ರೀ ಸತ್ಯಗಣಪತಿಯ ದಿವ್ಯ ಕೃಪೆಯು ನಿಮಗೆ ಮತ್ತು ನಿಮ್ಮ ಕುಟುಂಬಕ್ಕೆ ಸಮೃದ್ಧಿ, *ಆರೋಗ್ಯ, ಸಂತೋಷ ಮತ್ತು ಸಮೃದ್ಧಿಯನ್ನು* ನೀಡಲಿ. ✨\n\n` +
      `ನಿಮ್ಮ ಉದಾರ ಕೊಡುಗೆಗಾಗಿ ಧನ್ಯವಾದಗಳು!\n\n` +
      `ಇಂದಿನ ಪೂಜಾ ಫೋಟೋ ಇಲ್ಲಿದೆ:\n\n ${photoUrl}`
    );
  };
